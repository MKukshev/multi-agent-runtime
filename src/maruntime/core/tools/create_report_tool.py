...
class CreateReportTool(PydanticTool):
    """Create a comprehensive detailed report with citations as a final step of research.
    ...
    content: str = Field(
        description=(
            "Write comprehensive research report following the REPORT CREATION GUIDELINES from system prompt. "
    ...
    async def __call__(
        ...
        **kwargs: Any,
        ...
        reports_dir = (config or {}).get("reports_dir", "./reports")
